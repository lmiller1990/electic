...
<p align="center">Snippet: A simple login form component, It makes a request using axios.</p>
...
```
<p align="center">Snippet: Using a mock implementation of axios to test the login workflow.</p>
...
```
<p align="center">Snippet: A simple Vuex store.</p>
...
```
<p align="center">Snippet: Using Vuex in the login component.</p>
...
```
<p align="center">Snippet: Updating the test to use Vuex.</p>
...
```
<p align="center">Snippet: Converting the component to use the Component API.</p>
...
```
<p align="center">Snippet: Mocking Vuex. </p>
...
![](https://raw.githubusercontent.com/lmiller1990/electic/master/screenshots/api-map.png)
<p align="center">Image: Authentication dependency chain</p>

The previous test, where we mocked Vuex, mocks the dependency chain here:

![](https://raw.githubusercontent.com/lmiller1990/electic/master/screenshots/api-vuex.png)
<p align="center">Image: Mocking Vuex</p>
...
![](https://raw.githubusercontent.com/lmiller1990/electic/master/screenshots/api-axios.png)
<p align="center">Image: Mocking Axios</p>
...
```
<p align="center">Snippet: Boilerplate code to mock axios.</p>
...
```
<p align="center">Snippet: A basic server with msw.</p>
...
```
<p align="center">Snippet: Using msw instead of mocking axios.</p>
...
```
<p align="center">Snippet: Keeping track of posted data.</p>
...
```
<p align="center">Snippet: A test for a failed request.</p>
